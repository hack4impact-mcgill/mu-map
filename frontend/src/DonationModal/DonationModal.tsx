    ...
    >
      <DialogContent>
        <DialogContentText>
          {
            <div>
                <Typography variant="h4" className={classes.title}>Congrats</Typography>
              <p>
                MU's mission is to beautify the city of Montreal by creating
                murals that are anchored in local communities. At the hear of
                its approach is the desire to see and experience art on a daily
                basis, to trigger a social transformation and to turn Montreal
